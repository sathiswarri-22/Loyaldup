      ...
      <div className="container mx-auto px-4 sm:px-6 py-8">
        <div className="flex items-center mb-8">
          <button
            ...
            className="p-2 bg-white text-gray-700 rounded-full shadow hover:shadow-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
            aria-label="Go back"
          >
            <ChevronLeft size={22} />
          </button>

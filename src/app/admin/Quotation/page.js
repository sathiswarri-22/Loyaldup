      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <button
            ...
            className="p-2 bg-white text-indigo-600 rounded-full shadow-md hover:bg-indigo-50 transition-all focus:outline-none focus:ring-2 focus:ring-indigo-500 flex items-center gap-2"
          >
            <ChevronLeft size={18} />

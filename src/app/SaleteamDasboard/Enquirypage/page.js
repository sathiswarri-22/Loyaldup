        ...
        <form onSubmit={handlesubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <textarea
              ...
              className="w-full p-3 pl-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400"
            />
            <label className="block text-sm font-medium text-gray-600">Sales Head ID</label>
            <select
              name="Eid"
              value={enquiry.Eid}
              onChange={handlechange}
          ...
          <div className="flex justify-center">
            <button type="submit" className="bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400">
              Submit Enquiry
            </button>
          </div>
        </form>
